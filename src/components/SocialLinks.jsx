...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/rupert-dela-cruz-2761b22b7/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@_phertea",
    icon: Instagram,
    url: "https://www.instagram.com/_phertea/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@phert1115",
    icon: Youtube,
    url: "https://www.youtube.com/@phert1115",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@phertphert",
    icon: Github,
    url: "https://github.com/phertphert",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-br dark:from-white/10 from-black/10 dark:to-white/5 to-black/5 rounded-2xl p-6 py-8 backdrop-blur-xl transition-colors duration-500">
      <h3 className="text-xl font-semibold dark:text-white text-black mb-6 flex items-center gap-2 transition-colors duration-500">
  ...
  className="group relative flex items-center justify-between p-4 rounded-lg 
             dark:bg-white/5 bg-black/5 border dark:border-white/10 border-black/10 overflow-hidden
             dark:hover:border-white/20 hover:border-black/20 transition-all duration-500"
>
  ...
  <div className="relative flex items-center gap-4">
    ...
    <div className="flex flex-col">
      <span className="text-lg font-bold pt-[0.2rem] dark:text-gray-200 text-gray-800 tracking-tight leading-none dark:group-hover:text-white group-hover:text-black transition-colors duration-300">
        {linkedIn.displayName}
      </span>
      <span className="text-sm dark:text-gray-400 text-gray-600 dark:group-hover:text-gray-300 group-hover:text-gray-700 transition-colors duration-300">
        {linkedIn.subText}
      </span>
    </div>
  </div>
  ...
  {/* External Link */}
  <ExternalLink 
    className="relative w-5 h-5 text-gray-500 dark:group-hover:text-white group-hover:text-black
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-r from-transparent dark:via-white/10 via-white/20 to-transparent
          ...
          {[instagram, youtube].map((link) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-sm font-bold dark:text-gray-200 text-gray-700 dark:group-hover:text-white group-hover:text-black transition-colors duration-300">
                  {link.displayName}
                </span>
                <span className="text-xs dark:text-gray-400 text-gray-600 truncate dark:group-hover:text-gray-300 group-hover:text-gray-700 transition-colors duration-300">
                  {link.subText}
                </span>
              </div>
              
              <ExternalLink className="w-4 h-4 text-gray-500 dark:group-hover:text-white group-hover:text-black ml-auto
                                     opacity-0 group-hover:opacity-100 transition-all duration-300
