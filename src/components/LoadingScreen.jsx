...
const LoadingScreen = () => {
  return (
    <div className="min-h-screen dark:bg-[#030014] bg-[#f8f6f8] flex items-center justify-center">
      <div className="relative">
        ...
        <div className="relative flex flex-col items-center gap-4 p-8">
          ...
          <div className="relative">
            ...
            <span className="relative dark:text-gray-200 text-gray-800 text-sm">Loading...</span>
          </div>
        </div>
      </div>
    </div>
